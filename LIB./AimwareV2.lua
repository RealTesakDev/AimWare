...
charactertab:AddToggle("gunChem", { Text = "gun chams", Default = false }):OnChanged(function(Value1)
    toggleGunChams(aa)
end)

charactertab:AddToggle("HandChem", { Text = "Arm chams", Default = false }):OnChanged(function(Value)
    HandChamsEnabled(Value)
end)
